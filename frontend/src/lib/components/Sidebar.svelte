...
<aside class="w-80 border-r border-[#2a2a2d] flex flex-col bg-[#161619] h-full shrink-0">
	<div class="p-4 border-b border-[#2a2a2d] flex space-x-2">
		<input 
			...
			class="bg-[#202024] border border-[#333] rounded px-3 py-1.5 text-sm flex-1 text-white focus:outline-none"
			bind:value={appState.searchQuery}
		/>
		<button 
			onclick={() => appState.createNewTarget()}
			class="bg-[#2a2a2d] hover:bg-[#333] border border-[#444] text-white px-3.5 py-1.5 rounded text-sm font-bold transition-colors"
		>
			+
		</button>
	</div>
